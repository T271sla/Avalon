...
public static class Pathfinding
{
    ...
    {
        // You can customize this heuristic based on your game's requirements.
    ...
    private static float GetDistanceBetween(Tile tileA, Tile tileB)
    {
        // You can customize this function based on your game's requirements.
        return Vector2.Distance(tileA.transform.position, tileB.transform.position);
    }
}
